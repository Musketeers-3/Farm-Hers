    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4.5 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3.5">
              {mounted && (
                ...
                >
                  {isDark ? (
                    <Sun className="w-5.5 h-5.5 text-[#14532d]" strokeWidth={2} />
                  ) : (
              ...
              >
                <Bell className="w-5.5 h-5.5 text-[#14532d]" strokeWidth={2} />
          ...
          <div className="flex flex-row items-center justify-between gap-4 pt-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-white shadow-sm border-none">
                <MapPin className="w-4 h-4 text-[#16a34a]" strokeWidth={2.5} />
                <span className="text-[13px] font-black text-[#14532d] truncate max-w-[110px]">
                  {userLocation || "Location"}
                </span>
                <ChevronDown className="w-3.5 h-3.5 text-[#15803d]/30" strokeWidth={3} />
              </button>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* --- UNIFIED GLASS CONTAINER (SEARCH + SIDEBAR) --- */}
          ...
          {/* MAIN BLOCK (Recommendations, Commodities, Fields) */}
