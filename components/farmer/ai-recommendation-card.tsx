...
export function AIRecommendationCard() {
  ...
  return (
    <Card className="w-full overflow-hidden rounded-2xl sm:rounded-3xl border-0 relative
      bg-gradient-to-br from-[#e8f5e9] via-[#f0fdf4] to-[#d1fae5]
      dark:from-[#052e16] dark:via-[#071f0f] dark:to-[#064e3b]
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        <svg
          ...
          className="w-full h-full opacity-[0.22] dark:opacity-[0.12]"
        >
          <defs>
          ...
          {[0, 8, 16, 24, 32, 40, 50].map((offset, i) => (
            <path
              key={`r${i}`}
              d={`M500 ${-10 + offset} C620 ${60 + offset}, 780 ${180 + offset}, 960 ${100 + offset}`}
              fill="none"
              stroke="url(#waveGradLight)"
              strokeWidth={0.8}
              strokeLinecap="round"
      ...
      {/* Glass sheen — top highlight (light mode only) */}
      <div
      ...
      <div className="relative p-4 sm:p-6 space-y-5">
        ...
        <div className="flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-xl flex items-center justify-center relative flex-shrink-0
              bg-white/55 dark:bg-white/10 backdrop-blur-[12px]"
            style={{
              boxShadow: "0 2px 8px rgba(34,197,94,0.2), inset 0 1px 0 rgba(255,255,255,0.9)",
          ...
          <div>
            <h3 className="text-base sm:text-lg font-bold tracking-tight text-[#14532d] dark:text-emerald-200">
              AI Crop Recommendation
            </h3>
            <p className="text-xs font-medium text-[#14532d]/55 dark:text-emerald-400/60">
        ...
        <motion.div
          ...
          style={{
            boxShadow: "0 4px 24px rgba(34,197,94,0.1), inset 0 1px 0 rgba(255,255,255,0.85)",
          }}
        >
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-3 flex-wrap">
              <span className="text-xl sm:text-2xl font-bold tracking-tight text-[#14532d] dark:text-emerald-200">
                Grow {top.crop}
              </span>
              <div
                className="flex items-center gap-1 px-2.5 py-1 rounded-full
                  bg-[rgba(34,197,94,0.15)] dark:bg-emerald-500/20
                  border border-[rgba(34,197,94,0.35)] dark:border-emerald-500/30
            ...
            <button
              className="hidden sm:flex items-center gap-1 text-xs font-semibold text-[#16a34a] dark:text-emerald-400 hover:text-[#15803d] dark:hover:text-emerald-300 transition-colors"
            >
              Full Analysis <ChevronRight className="w-4 h-4" />
            </button>
          </div>

          <p className="text-sm font-medium leading-relaxed max-w-2xl text-[#14532d]/72 dark:text-emerald-300/70">
            {top.reason}
          </p>
            ...
            {top.factors.map((f, i) => (
              <motion.div
                ...
                className={cn(
                  ...
                  f.positive
                    ? "text-[#15803d] dark:text-emerald-300 border border-[rgba(34,197,94,0.3)] dark:border-emerald-500/25 bg-white/55 dark:bg-emerald-900/30"
                    : "text-[#b91c1c] dark:text-red-400 border border-[rgba(239,68,68,0.25)] dark:border-red-500/25 bg-white/45 dark:bg-red-900/20"
                )}
                style={{
        ...
        <div className="pt-1">
          <h4 className="text-xs font-bold uppercase tracking-wider mb-3 px-1 flex items-center gap-1.5 text-[#14532d]/45 dark:text-emerald-500/60">
            ...
            {recommendations.slice(1).map((rec, i) => (
              <motion.div
                ...
                className="flex items-center justify-between p-3 rounded-xl cursor-pointer group transition-all duration-200
                  ...
                  hover:border-[rgba(34,197,94,0.4)] dark:hover:border-emerald-500/30
                  backdrop-blur-[12px]"
                style={{
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="text-sm font-bold text-[#14532d] dark:text-emerald-200">
                    {rec.crop}
                  </span>
                  <span
                    className="text-[11px] font-semibold px-2 py-0.5 rounded-md
                      text-[#14532d]/50 dark:text-emerald-400/60
                ...
                <ChevronRight
                  className="w-4 h-4 text-[#16a34a] dark:text-emerald-400 transition-all duration-200 group-hover:translate-x-0.5"
                />
              </motion.div>
            ))}
          </div>
