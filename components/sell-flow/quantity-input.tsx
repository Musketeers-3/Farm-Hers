// components/farmer/sell-flow/quantity-input.tsx
"use client";
...
export function QuantityInput({ crop, quantity, onQuantityChange, getCropName, t }: {
  crop: Crop;
  quantity: number;
  ...
  return (
    <div className="space-y-8 flex flex-col items-center">
      <div className="inline-flex items-center gap-3 bg-secondary/50 backdrop-blur-md px-4 py-2 rounded-full border border-border/50">
        ...
        />
        <span className="text-sm font-semibold text-foreground">{getCropName(crop)}</span>
        <span className="text-muted-foreground">|</span>
        <span className="text-sm font-medium text-muted-foreground">₹{crop.currentPrice}/q</span>
      </div>
      <div className="flex flex-col items-center w-full mt-4">
        ...
        <input
          ...
          placeholder="0"
        />
        <span className="text-xl font-bold text-primary mt-2">{t.quintals}</span>
      </div>
        ...
        {quantity > 0 && (
          ...
          >
            ...
            <div className="flex items-start">
              <span className="text-3xl text-foreground font-light mr-1">₹</span>
