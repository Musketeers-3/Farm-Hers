// FBO simulation + render shaders for the curl-noise particle vortex.
// Recolored to FarmHers Green/Gold for the premium agricultural aesthetic.
...
export const renderFragmentShader = /* glsl */ `
  ...
  void main() {
    ...
    vec3 coreColor = vec3(0.13, 0.77, 0.36); // #22c55e
    vec3 edgeColor = vec3(0.98, 0.75, 0.14); // #fbbf24
    
    vec3 finalColor = mix(coreColor, edgeColor, smoothstep(-3.0, 3.0, vDepth));

    float alpha = 1.0 - (dist * 2.0);
    
    gl_FragColor = vec4(finalColor * 1.4, alpha * 0.85);
  }
`;