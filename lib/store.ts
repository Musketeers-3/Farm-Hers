...
export type OrderStatus = 'pending' | 'in-transit' | 'quality-verified' | 'payment-released'
...
export const useAppStore = create<AppState>()(
  persist(
    (set) => ({
      ...
      joinPool: (poolId, quantity) => set((state) => ({
      ...
      placeBid: (auctionId, amount, bidderId) => set((state) => ({
...
export type Screen = 'dashboard' | 'sell' | 'auction' | 'tracking' | 'market' | 'onboarding'
